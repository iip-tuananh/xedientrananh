...
@section('buttons')
    <a href="javascript:void(0)" class="btn btn-outline-success" data-toggle="modal" data-target="#create-product-rate"
        class="btn btn-info" ng-click="errors = null"><i class="fa fa-plus"></i> Thêm mới</a>
@endsection
@section('content')
    <div ng-cloak>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success btn-cons" ng-click="submitUpdateStatus()"
        ...
        @include('admin.product_rates.create')
        @include('admin.product_rates.edit')
    </div>
@endsection

@section('script')
    @include('admin.product_rates.ProductRate')
    ...
    <script>
        ...
        app.controller('ProductRate', function($rootScope, $scope, $http) {
            ...
            $scope.formUpdateStatus = {};
            $scope.statues = [{
                    id: 2,
                    name: 'Duyệt và xuất bản'
                },
                {
                    id: 0,
                    name: 'Không duyệt'
            ...
            $('#table-list').on('click', '.update-status', function() {
                ...
                $scope.formUpdateStatus.status = $scope.data.status;
                $scope.$apply();
            ...
            $scope.submitUpdateStatus = function() {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        status: $scope.formUpdateStatus.status
                    },
