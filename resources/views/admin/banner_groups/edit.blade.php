    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('admin.banner_groups.form')
            </div>
...
<script>
    app.controller('EditReview', function ($rootScope, $scope, $http) {
        $rootScope.$on("editReview", function (event, data){
           $scope.form = new BannerGroup(data, {scope: $scope});
           $scope.$applyAsync();
        ...
        $scope.submit = function () {
            let url = "/admin/banner-groups/" + $scope.form.id + "/update";
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.success) {
                        ...
                        $scope.form = new BannerGroup({}, {scope: $scope});
