                                ...
                                <div
                                    ...
                                    <div class="main-menu mainMenujs">
                                        ...
                                        <ul class="link-list sub-child" id="104673963">
                                            ...
                                            <li>
                                                <a href="/collections/hot-products"
                                                   title="Sản phẩm bán chạy"><span>-</span>Sản phẩm bán chạy</a>
                                            </li>
                                            <li>
                                                <a href="/collections/onsale"
                                                   title="Sản phẩm khuyến mãi"><span>-</span>Sản phẩm khuyến mãi</a>
                                            </li>
                                            <li>
                                                <a href="/collections/hot-products"
                                                   title="Sản phẩm nổi bật"><span>-</span>Sản phẩm nổi bật</a>
                                            </li>
                                            <li>
                                                <a href="/pages/landing-page"
                                                   title="Landing Page"><span>-</span>Landing Page</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104673990">
                                            <li><a href="javascript:;"><i class="fa fa-angle-left"
                                                                          aria-hidden="true"></i>Quay về</a></li>
                                            <li><a href="/products/iphone-12-pro-max-128gb"><b>Xem tất cả "Product
                                                        Views"</b></a></li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/products/iphone-12-pro-max-128gb?view=style-01"
                                                   title="Kiểu hiển thị 1"><span>-</span>Kiểu hiển thị 1</a>
                                            </li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/products/iphone-12-pro-max-128gb?view=style-02"
                                                   title="Kiểu hiển thị 2"><span>-</span>Kiểu hiển thị 2</a>
                                            </li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/products/iphone-12-pro-max-128gb?view=style-03"
                                                   title="Kiểu hiển thị 3"><span>-</span>Kiểu hiển thị 3</a>
                                            </li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/products/iphone-12-pro-max-128gb?view=style-04"
                                                   title="Kiểu hiển thị 4"><span>-</span>Kiểu hiển thị 4</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104673965">
                                            ...
                                            <li>
                                                <a href="https://techgo.myharavan.com/pages/about-us?view=about-01"
                                                   title="Giới thiệu 01"><span>-</span>Giới thiệu 01</a>
                                            </li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/pages/about-us?view=about-02"
                                                   title="Giới thiêu 02"><span>-</span>Giới thiêu 02</a>
                                            </li>
                                            <li>
                                                <a href="https://techgo.myharavan.com/pages/about-us?view=about-03"
                                                   title="Giới thiệu 03"><span>-</span>Giới thiệu 03</a>
                                            </li>
                                            <li>
                                                <a href="/pages/about-us" title="Về chúng tôi"><span>-</span>Về chúng
                                                    tôi</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="/pages/he-thong-cua-hang"
                                                   title="Hệ thống cửa hàng"><span>-</span>Hệ thống cửa hàng</a>
                                            </li>
                                            <li>
                                        ...
                                        <ul class="link-list sub-child" id="104674053">
                                            ...
                                            <li>
                                                <a href="/pages/chinh-sach-doi-tra"
                                                   title="Chính sách đổi trả"><span>-</span>Chính sách đổi trả</a>
                                            </li>
                                            <li>
                                                <a href="/pages/chinh-sach-bao-mat"
                                                   title="Chính sách bảo mật"><span>-</span>Chính sách bảo mật</a>
                                            </li>
                                            <li>
                                                <a href="/pages/dieu-khoan-dich-vu"
                                                   title="Điều khoản dịch vụ"><span>-</span>Điều khoản dịch vụ</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104381399">
                                            ...
                                            <li>
                                                <a href="/" class="current"
                                                   title="Daikin"><span>-</span>Daikin</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Toshiba"><span>-</span>Toshiba</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Aqua"><span>-</span>Aqua</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Asanzo"><span>-</span>Asanzo</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104381406">
                                            ...
                                            <li>
                                                <a href="/" class="current"
                                                   title="Samsung"><span>-</span>Samsung</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Toshiba"><span>-</span>Toshiba</a>
                                            ...
                                            <li>
                                                <a href="/" class="current"
                                                   title="Panasonic"><span>-</span>Panasonic</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Aqua"><span>-</span>Aqua</a>
                                        ...
                                        <ul class="link-list sub-child" id="104381417">
                                            <li><a href="javascript:;"><i class="fa fa-angle-left"
                                                                          aria-hidden="true"></i>Quay về</a></li>
                                            <li><a href="/collections/all"><b>Xem tất cả "Laptop theo thương
                                                        hiệu"</b></a></li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Apple"><span>-</span>Apple</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Dell"><span>-</span>Dell</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="/" class="current"
                                                   title="Asus"><span>-</span>Asus</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Lenovo"><span>-</span>Lenovo</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="MSI"><span>-</span>MSI</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104381424">
                                            ...
                                            <li>
                                                <a href="/" class="current"
                                                   title="Dưới 10 triệu"><span>-</span>Dưới 10 triệu</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="10 - 15 triệu"><span>-</span>10 - 15 triệu</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="15 - 20 triệu"><span>-</span>15 - 20 triệu</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="20 - 25 triệu"><span>-</span>20 - 25 triệu</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="25 - 30 triệu"><span>-</span>25 - 30 triệu</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Trên 30 triệu"><span>-</span>Trên 30 triệu</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104381431">
                                            <li><a href="javascript:;"><i class="fa fa-angle-left"
                                                                          aria-hidden="true"></i>Quay về</a></li>
                                            <li><a href="/collections/all"><b>Xem tất cả "Laptop theo kích
                                                        thước"</b></a></li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Dưới 13 inch"><span>-</span>Dưới 13 inch</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="13 - 15 inch"><span>-</span>13 - 15 inch</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Trên 15 inch"><span>-</span>Trên 15 inch</a>
                                            </li>
                                        </ul>
                                        <ul class="link-list sub-child" id="104381435">
                                            <li><a href="javascript:;"><i class="fa fa-angle-left"
                                                                          aria-hidden="true"></i>Quay về</a></li>
                                            <li><a href="/collections/all"><b>Xem tất cả "Linh kiện laptop"</b></a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Bàn phím laptop"><span>-</span>Bàn phím laptop</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Pin laptop"><span>-</span>Pin laptop</a>
                                            </li>
                                            <li>
                                                <a href="/" class="current"
                                                   title="Sạc laptop"><span>-</span>Sạc laptop</a>
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="cart-view clearfix">
                                ...
                                <tr class="mini-cart__item " ng-repeat="item in cart.items">
                                    ...
                                    <td class="mini-cart__right">
                                        ...
                                        <div class="mini-cart__quantity">
                                            ...
                                            <button class="qty-btn mnc-minus" ng-click="decrementQuantity(item); changeQty(item.quantity, item)">
                                            ...
                                            <input class="qty-value  " type="text" readonly="" name="mnc-quantity"
                                                   ng-model="item.quantity" data-vid="1086987163">
                                            <button class="qty-btn mnc-plus" ng-click="incrementQuantity(item); changeQty(item.quantity, item)">
                                                <svg width="18" height="18" viewBox="0 0 20 20"
                                                     xmlns="http://www.w3.org/2000/svg">
                                                    <rect x="9" y="1" width="1" height="17"></rect>
                                                    <rect x="1" y="9" width="17" height="1"></rect>
                        ...
                        <div class="cart-view-total">
                            <table class="table-total">
                                ...
                                <tr>
                                    <td class="mnc-total text-left">TỔNG TIỀN:</td>
                                    <td class="mnc-total text-right total-view-cart"><% cart.total | number %>₫</td>
                                </tr>
                                <tr class="mini-cart__button">
